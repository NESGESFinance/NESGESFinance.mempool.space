...
export const MempoolErrors = {
  ...
  'invalid_tx_dependencies': `This transaction's dependencies are not valid.`,
  ...
  'not_available': `Your current subscription does not allow you to access this feature.`,
  'not_enough_balance': ``,
